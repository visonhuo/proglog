...
import (
	...
	"github.com/visonhuo/proglog/internal/discovery"
	"github.com/visonhuo/proglog/internal/log"
	"github.com/visonhuo/proglog/internal/server"
	"go.uber.org/zap"
...
// Agent type that manages the different components
// and processes that make up the service.
type Agent struct {
	Config
	log        *log.Log
	server     *grpc.Server
...
func (a *Agent) setupMembership() error {
	...
	a.replicator = &log.Replicator{
		DialOptions: opts,
		LocalServer: api.NewLogClient(conn), // the client which connect to local server
	}
